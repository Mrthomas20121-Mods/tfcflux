package mrthomas20121.tfcflux.objects.items.dust;
...
import static mrthomas20121.tfcflux.objects.CreativeTabsTFCFlux.CT_Metals;
...
public class ItemDust extends ItemTFC {
    ...
    public ItemDust(Dust dust)
    {
        ...
        this.setRegistryName(TfcFlux.MODID, name);
        this.setTranslationKey(TfcFlux.MODID + "." + name.replace('/', '.'));
